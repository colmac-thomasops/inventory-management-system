				  ...
				  <div class="card-body">
					...
					<div class="tab-content">
						...
						<div id="itemImageTab" class="container-fluid tab-pane fade">
							...
							<p>You can upload an image for a particular item using this section (LIMIT IS 5MB).</p> 
				  ...
				  <div id="vendorDetailsMessage"></div>
					 <form> 
					  ...
					  <div class="form-row">
						  ...
						  <div class="form-group col-md-3">
							<label for="vendorDetailsVendorPhone2">Phone 2 (optional)</label>
				  ...
				  <div class="card-body">
					...
					<form>
					  ...
					  <div class="form-row">
						  ...
						  <div class="form-group col-md-3">
							  <label for="saleDetailsSaleDate">Sales Date<span class="requiredIcon">*</span></label>
    ...
    <div class="grid-container">
      ...
      <!-- End Main -->
			  ...
			  <div class="tab-pane fade" id="v-pills-reports" role="tabpanel" aria-labelledby="v-pills-reports-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header">Inventory<button id="reportsTablesRefresh" name="reportsTablesRefresh" class="btn btn-warning float-right btn-sm">Refresh</button></div>
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
